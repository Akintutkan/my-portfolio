...
import clover from "../../assets/icons8-clover-64.png"


const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Ahmet Akın Tutkan  
        {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                >
                 ...
                 <img src={clover} width="40px" alt=""></img>
         </h1>
        <h3 className="home__subtitle">Frontend Developer</h3>
        <p className="home__description">Hi I'm Akin, a former geophysical engineer and a new frontend developer.</p>
